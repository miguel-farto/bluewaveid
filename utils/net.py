# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 17:10:35 2021

@author: user01
"""

from utils.senet import *
from utils.marginlinear import *
...
class BinaryHead(nn.Module):
    ...
    def __init__(self, num_class=2000, emb_size = 226, s = 16.0):
...
class MarginHead(nn.Module):
    ...
    def __init__(self, num_class=2000, emb_size = 226, s=64., m=0.5):
...
class Net(nn.Module):
    ...
    def __init__(self, num_class=2000, s1 = 64 , m1 = 0.5, s2 = 64):
